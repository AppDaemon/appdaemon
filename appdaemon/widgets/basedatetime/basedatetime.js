function basedatetime(widget_id, url, skin, parameters)
{
    ...
    function OnChange(self, state)
    {
        ...
        {
            has_date = self.entity_state[self.entity].attributes.has_date
            has_time = self.entity_state[self.entity].attributes.has_time
            ...
            if (has_date && has_time) {
                ...
                args["date"] = self.state
            }
            else {
                args["time"] = self.state
            }
    ...
    function set_value(self, state)
    {
        ...
        // self.set_field(self, "textValue", self.format_number(self,value))
    }
