...
To configure the MQTT plugin, in addition to the required parameters above, you will need to add the following:
 ...
 - ``namepace:`` (optional) This will default to ``mqtt``
 ...
 - ``client_id:`` (optional) The client id to be used by the plugin, to connect to the broker. If not declared, this will be auto generated. The generated the client id can be retreived within the app
